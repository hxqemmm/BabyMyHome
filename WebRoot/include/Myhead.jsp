    ...
    <div class="layout bg-blue bg-inverse">
      <div class="container height">
        <span class="float-right text-small text-white hidden-l">
          <a class="text-white" href="#"></a><span> </span><a class="text-white" href="longin.html"></a><span> </span><a class="text-white" href="register.jsp">注册</a><span> | </span><a class="text-white" href="longin.jsp">登入</a>
        </span>
