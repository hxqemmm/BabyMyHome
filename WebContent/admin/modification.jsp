...
<body>
  	...
  	<hr>
  	<form action="userinfo?method=userinfo_modify&id=${sessionScope.list[0].id}" name="form" method="post" enctype="multipart/form-data">
  	<div  id="box_relative"><img src="../${sessionScope.list[0].headimage}" width="120" height="150" alt="浏览器不支持" /><br><input type="file"  name="file"></div>
	<table align="center">
	
		<tr>
			<td align="left">用户名:</td>
			<td><input type="text" name="username" value="${sessionScope.list[0].username}" id="input1"  onBlur="a(this)" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input type="radio" name="sex" value="女"  
				<c:if test="${sessionScope.list[0].sex eq '女'}">checked</c:if>
			/>女
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="sex"" value="男"  
				<c:if test="${sessionScope.list[0].sex eq '男'}">checked</c:if>
			/>男</td>
		</tr>
		<tr>
			<td align="left">年龄:</td>
			<td><input type="text" name="age"  value="${sessionScope.list[0].age}" id="input6" onblur="k(this)"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="phone" value="${sessionScope.list[0].phone}" id="input4" onblur="d(this)" readonly="readonly"/></td>
		</tr>
		<tr>
			<td align="left">密码:</td>
			<td><input type="password"  name="password" value="${sessionScope.list[0].password}" id="input3" onblur="i(this)"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left">籍贯:</td>
			<td><input type="text" name="jiguan" value="${sessionScope.list[0].natives}" id="input6" onblur="f(this)"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left">QQ:</td>
			<td><input type="text" name="qq" value="${sessionScope.list[0].QQ}"  id="input7" onblur="g(this)"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea rows="5" name="sdasd" cols="30"  onblur="j(this)"/>${sessionScope.list[0].sdasd}</textarea></td>
		</tr>
		<tr>
